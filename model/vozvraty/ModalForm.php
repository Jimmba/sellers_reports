...
class ModalForm{
    ...
    private function createChangeForm($id){
        ...
        $db->setQuery("SELECT
            ...
            WHERE vozvrat.komuVozvrat = sotrudniki_1.id_prod
            AND vozvrat.id_vozvrat = $id
                        ...
                        <div class=\"modal-content\">
                            ...
                            <div class=\"modal-body\">
                                <form action='crud.php' method='post' id = \"$this->idForm\">
                                    ...
                                    <div class=\"form-group input\">
                                        <label for=\"sotr\">Кто продавал</label>
                                            $this->komu
                                    </div>
                    ...
                    $(\"#addForm\").submit(function (e) {
                        ...
                        $.ajax({
                            ...
                            success: function () {
                                  $(\".modal\").hide();
                                  $(\".modal-backdrop\").hide();
                                  $(\"#content\").load('model/vozvraty/data.php'); // скроллбар не добавляется
