    ...
    echo"<div class=\"tab-pane\" id=\"expenses\" role=\"tabpanel\">
        <table class=\"table table-bordered table-striped\">
            ...
            while ($row = $STH->fetch()) {
                ...
                </tr>", $row["date"], $row["magname"], $row["name"], $row["perevod_sto(x100)"] / 100, $row["id_prih"], $row["id_prih"]);
            }
            echo"
            </tbody>
        </table>
